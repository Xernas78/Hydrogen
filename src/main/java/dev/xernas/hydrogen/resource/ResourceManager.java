...
public class ResourceManager {
    ...
    public ShaderResource readShaderResource(Path resourcePath) throws PhotonException {
        ...
        return new ShaderResource(shaderName, vertexShaderResource, fragmentShaderResource);
    }
    ...
    public IShader shaderResourceToShader(Lib lib, ShaderResource shaderResource) throws PhotonException {
        switch (lib) {
            case OPENGL -> {
                ...
                return new GLShader(shaderResource.name, vertexCode, fragmentCode);
            }
            default -> {
    ...
    public record ShaderResource(String name, TypeShaderResource vertex,
