...
public class ResourceManager {
    ...
    public IShader shaderResourceToShader(Lib lib, ShaderResource shaderResource) throws PhotonException {
        switch (lib) {
            case OPENGL -> {
                ...
                return new GLShader(shaderResource.name, shaderResource.hasLightingSystem, shaderResource.hasPostProcessing, vertexCode, fragmentCode);
            }
            default -> {
    ...
    public record ShaderResource(String name, boolean hasLightingSystem, boolean hasPostProcessing, TypeShaderResource vertex,
